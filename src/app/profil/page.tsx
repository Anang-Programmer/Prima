          ...
          {!d.isPremium && (
            <section className="px-5 mt-4 md:px-0">
              <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#002D3A] to-[#00586D] p-5 ">
                {/* Garis dekoratif — sisi kanan */}
                <img src="/images/items/garis.png" alt="" className="pointer-events-none absolute -bottom-14 right-0 h-[120%] w-[75%] object-contain object-right opacity-25" />
                <div className="relative z-10">
                  <h3 className="text-[17px] font-medium text-white tracking-wide">Upgrade Akun ke Prime</h3>
                  <p className="mt-1.5 text-[12px] text-white/70 leading-relaxed mb-6 max-w-[70%]">Tambah kolam lebih banyak, koneksi semau tambak dalam satu genggaman</p>
